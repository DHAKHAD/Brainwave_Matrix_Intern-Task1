...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        register_login_screen = tk.Button(dualtone_label,text='Use another account',font=('orbitron',12),command=popup2,relief='raised',borderwidth=3,width=23,height=3).pack(pady=10,side='bottom')
        ...
        credits=tk.Label(bottom_frame,text='Created and Develped by Sunil Nagar',font=('orbitron',15)).pack()
